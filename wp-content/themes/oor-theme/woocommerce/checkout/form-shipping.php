<?php
/**
 * Checkout shipping form (OOR theme override)
 * Если get_checkout_fields('shipping') пустой — подставляем поля из get_address_fields(), чтобы блок не был пустым.
 *
...
// OOR: если фильтры обнулили shipping — восстанавливаем стандартные поля
