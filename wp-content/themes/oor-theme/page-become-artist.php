    ...
    <div class="oor-container oor-become-artist-container">
        <div class="oor-become-artist-content-wrapper">
            ...
            <div class="oor-become-artist-instructions">
                <div class="oor-become-artist-instructions-col">
                    <p class="oor-become-artist-instructions-text">
                        Демо-материалы рассматриваются только в виде ссылок на потоковое прослушивание (YouTube, SoundCloud, Я. Диск и т.д.)<br><br>
                        Прослушивание демозаписей командой лейбла занимает до 3х недель
                    </p>
                </div>
                <div class="oor-become-artist-instructions-col">
                    <p class="oor-become-artist-instructions-text">
            ...
            <div class="oor-become-artist-form-wrapper">
                <div class="oor-become-artist-form-fields">
                    <?php
                    ...
                    if (function_exists('wpcf7_contact_form')) {
                        // Выводим форму
                        $form_output = do_shortcode('[contact-form-7 id="' . esc_attr($form_id) . '"]');
                        
                        // Обертываем каждое поле в нужную структуру через JavaScript или через обработку вывода
                        echo $form_output;
                    } else {
