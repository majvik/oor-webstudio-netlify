            ...
            <div class="oor-manifest-ceo-content">
                ...
                <div class="oor-manifest-ceo-text">
                    ...
                    <div class="oor-manifest-ceo-description">
                        <p>Российская певица, автор электронного проекта «Нет Времени Объяснять» и основатель, CEO лейбла Out of Records.</p>
                        <p>Через лейбл Out of Records Анастасия воплощает свою идею поддержки и продвижения новых артистов, создавая для них пространство роста, свободы и творческой реализации.</p>
                    </div>
